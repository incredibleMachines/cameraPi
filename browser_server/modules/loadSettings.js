exports.settings = 
  ...
  { name: 'Aperture', call: 'aperture', value: 0 ,options:[{name:'3.5'},{name:'4'},{name:'4.5'},{name:'5'},{name:'5.6'},{name:'6.3'},{name:'7.1'},{name:'8'},{name:'9'},{name:'10'},{name:'11'},{name:'13'},{name:'14'},{name:'16'},{name:'18'},{name:'20'},{name:'22'}]},
